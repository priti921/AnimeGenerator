...
function TopAiring() {
    ...
    let list = Loading ? (<p className="loading">Loading...</p>) : (
        TopAiring.map(item => {
            return (
        ...
        <>
            <div className="title-topAiring">
                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                    viewBox="0 0 512 512" className="icon" style={{ enableBackground: "new 0 0 512 512" }} >
                ...
                <h3 className="topAiring">Most Favorite</h3>
